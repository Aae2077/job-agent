  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        saved: "border-transparent bg-purple-500/20 text-purple-300 border-purple-500/30",
        applied: "border-transparent bg-yellow-500/20 text-yellow-300 border-yellow-500/30",
        interviewing: "border-transparent bg-orange-500/20 text-orange-300 border-orange-500/30",
